...
export const printAnswers = ({
  ...
  if (doPart1) {
    console.log(
      kleur.blue(
        `Day ${day}, Part 1 answer: ${answer1 ?? ''} (${checkAnswer(answer1, solution.part1)}) ${!doPart2 ? '\n' : ''}`,
      ),
    )
  }
  ...
  if (doPart2) {
    console.log(
      kleur.blue(
        `Day ${day}, Part 2 answer: ${answer2 ?? ''} (${checkAnswer(answer2, solution.part2)})\n`,
      ),
    )
  }
}
